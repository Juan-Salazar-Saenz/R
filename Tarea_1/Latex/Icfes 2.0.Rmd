...
leche <- pg_Genero_M$FAMI_COMELECHEDERIVADOS 
proteina <- pg_Genero_M$FAMI_COMECARNEPESCADOHUEVO 
cereales <- pg_Genero_M$FAMI_COMECEREALFRUTOSLEGUMBRE
computador <- pg_Genero_M$FAMI_TIENECOMPUTADOR

#Creamos el nuevo DF
puntuacion_df <- data.frame(estrato,leche,global,proteina,cereales,computador)

#Cambiamos los nombres
colnames(puntuacion_df) <- c("estrato","leche","global","proteina","cereales","computador")

 
ggplot(puntuacion_df) +
  aes(x=global, fill=leche) +
  geom_bar() +
  facet_wrap( ~ estrato) +
  labs(y="cantidad",x="Estrato",title="presentacion de examen por global y esrato / lacteos \n") +
  annotation_custom(get_img,xmin=-Inf,xmax=Inf,ymin=-Inf,ymax=Inf)# elimina grid de fondo

ggplot(puntuacion_df) +
  aes(x=global, fill=proteina) +
  geom_bar() +
  facet_wrap( ~ estrato) +
  labs(y="cantidad",x="Estrato",title="presentacion de examen por global y esrato / proteinas \n") +
  annotation_custom(get_img,xmin=-Inf,xmax=Inf,ymin=-Inf,ymax=Inf)# elimina grid de fondo

ggplot(puntuacion_df) +
  aes(x=global, fill=cereales) +
  geom_bar() +
  facet_wrap( ~ estrato) +
  labs(y="cantidad",x="Estrato",title="presentacion de examen por global y esrato / cereales \n") +
  annotation_custom(get_img,xmin=-Inf,xmax=Inf,ymin=-Inf,ymax=Inf)# elimina grid de fondo

ggplot(puntuacion_df) +
  aes(x=global, fill=computador) +
  geom_bar() +
  facet_wrap( ~ estrato) +
  labs(y="cantidad",x="Estrato",title="presentacion de examen por global y esrato / computador \n") +
  annotation_custom(get_img,xmin=-Inf,xmax=Inf,ymin=-Inf,ymax=Inf)# elimina grid de fondo
